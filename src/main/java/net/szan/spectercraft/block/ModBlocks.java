...
public class ModBlocks {
    ...
    public static final Block ACID = registerBlock("acid",
            new Block(FabricBlockSettings.copyOf(Blocks.HONEY_BLOCK).mapColor(MapColor.LIME)));
    public static final Block ERROR_BLOCK = registerBlock("error_block",
            new Block(FabricBlockSettings.copyOf(Blocks.DIRT).mapColor(MapColor.PURPLE)));
